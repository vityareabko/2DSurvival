...
namespace DevPlayer
{
    ...
    public class MiningRulesController : MonoBehaviour
    {
        ...
        private List<MiningResourcesBehavior> _resources;
        ...
        private void Awake()
        {
            _resources = new List<MiningResourcesBehavior>(_resourceBehavioursParent.GetComponentsInChildren<MiningResourcesBehavior>());
